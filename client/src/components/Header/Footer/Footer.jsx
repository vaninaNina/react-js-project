                ...
                <div className="row">
                    <div className="8u">
                        <section>
                            ...
                            <ul className="dates">
                                <li> <span className="date">Jan <strong>27</strong></span>
                                    <h3><a href="#">Lorem dolor sit amet veroeros</a></h3>
                                    <p>Ipsum dolor sit amet veroeros consequat blandit ipsum phasellus lorem consequat etiam.</p>
                                </li>
                                <li> <span className="date">Jan <strong>23</strong></span>
                    ...
                    <div className="4u">
                        <section>
                            ...
                            <a href="#" className="image image-full"><img src="images/pic10.jpg" alt=""/></a>
                            ...
                            <footer> <a href="#" className="button">Find out more</a> </footer>
                        </section>
                    </div>
                </div>
            </section>
