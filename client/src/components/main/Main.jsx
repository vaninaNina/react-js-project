            ...
            <div className="12u">
                ...
                <section>
                    ...
                    <div className="5grid">
                        <div className="row">
                            <div className="4u">
                                <section className="box"> <a href="#" className="image image-full"><img src="images/pic03.jpg" alt="" /></a>
                                    <header>
                                        <h3>Sed etiam lorem nulla</h3>
                                    </header>
                                    <p>Lorem ipsum dolor sit amet sit veroeros sed amet blandit consequat veroeros lorem blandit adipiscing et feugiat phasellus tempus dolore ipsum lorem dolore.</p>
                                    <footer> <a href="#" className="button button-alt">Find out more</a> </footer>
                                </section>
                            </div>
                            <div className="4u">
                                <section className="box"> <a href="#" className="image image-full"><img src="images/pic04.jpg" alt="" /></a>
                                    <header>
                            ...
                            <div className="4u">
                                <section className="box"> <a href="#" className="image image-full"><img src="images/pic07.jpg" alt="" /></a>
                                    <header>
                ...
                <section>
                    ...
                    <div className="5grid">
                        <div className="row">
                            <div className="6u">
                                <section className="box"> <a href="#" className="image image-full"><img src="images/pic08.jpg" alt="" /></a>
                                    <header>
                                        <h3>Magna tempus consequat lorem</h3>
                                        <span className="byline">Posted 45 minutes ago</span> </header>
                                    ...
                                    <footer className="actions"> <a href="#" className="button button-icon button-icon-1">Continue Reading</a> <a href="#" className="button button-alt button-icon button-icon-2">33 comments</a> </footer>
                                </section>
                            </div>
                            <div className="6u">
